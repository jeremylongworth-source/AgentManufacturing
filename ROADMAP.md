...
**2026-09-12 owner-requested publication: READY.** The development repository is public, matching funding and the reviewed README are pushed, and the overhauled 16-page Wiki plus navigation are published. See the [current acceptance record and handoff](docs/development/publication-2026-09-12.md). This later authorization does not change the AM-33 partial v1 verdict or the historical observations below.
