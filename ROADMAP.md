...
**2026-09-12 owner-requested publication: READY.** The development repository is public, matching funding and the reviewed README are pushed, and all 13 Wiki pages plus navigation are published. See the [current acceptance record and handoff](docs/development/publication-2026-09-12.md). This later authorization does not change the AM-33 partial v1 verdict or the historical observations below.
