...
**2026-09-12 owner-requested publication: READY.** The development repository is public, matching funding and the reviewed README are pushed, and the overhauled 14-page Wiki plus navigation are published. See the [current acceptance record and handoff](docs/development/publication-2026-09-12.md). This later authorization does not change the AM-33 partial v1 verdict or the historical observations below.
...
| AM-32 | READY | [Public-readiness record](docs/development/AM-32-public-readiness.md), [acceptance](tests/evaluations/AM-32-public-readiness-acceptance.md), and [handoff](docs/development/handoffs/AM-32-final-handoff.md). MIT, GitHub private vulnerability reporting and the private conduct form implemented; `AGENTMANUFACTURING_AM_32_PUBLIC_READINESS_READY` |
