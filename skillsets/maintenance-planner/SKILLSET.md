...
Prepare maintenance priorities and plans from backlog and failure evidence.
...
|---|---|---|---|---|
| `maintenance-priority` | Review backlog and propose maintenance priorities. | Backlog, risk criteria, resource constraints and equipment context. | Prioritized review list and parts evidence gaps. | No equipment shutdown/startup or procurement authority. |
| `preventive-plan` | Draft a preventive plan against failure evidence. | Failure history, manufacturer information and review criteria. | Preventive maintenance proposal. | No safe-to-work declaration or isolation instructions. |
...
- [analyze-maintenance-backlog](../../skills/family-10-maintenance-reliability/analyze-maintenance-backlog/SKILL.md).
- [prioritize-maintenance-work](../../skills/family-10-maintenance-reliability/prioritize-maintenance-work/SKILL.md).
- [review-spare-parts-criticality](../../skills/family-10-maintenance-reliability/review-spare-parts-criticality/SKILL.md).
- [analyze-failure-history](../../skills/family-10-maintenance-reliability/analyze-failure-history/SKILL.md).
- [build-preventive-maintenance-plan](../../skills/family-10-maintenance-reliability/build-preventive-maintenance-plan/SKILL.md).
...
```powershell
python scripts/resolve-skillset.py maintenance-planner maintenance-priority
```
